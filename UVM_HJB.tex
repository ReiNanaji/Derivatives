...
$u^{n+\frac{1}{2}}$ price.
\[
u_{i,j}^{n+1}-\alpha^{y}u_{i,j}^{n+1}-\zeta u_{i,j+1}^{n+1}-\eta u_{i,j-1}^{n+1}=\left(1+\alpha^{0}+\alpha^{x}\right)u_{i,j}^{n+\frac{1}{2}}+\beta u_{i+1.j}^{n+\frac{1}{2}}+\gamma u_{i-1,j}^{n+\frac{1}{2}}
\]
...
\end{enumerate}
\[
u_{i,j}^{n+\frac{1}{2}}-\alpha^{x}u_{i,j}^{n+\frac{1}{2}}-\beta u_{i+1,j}^{n+\frac{1}{2}}-\gamma u_{i-1,j}^{n+\frac{1}{2}}=\left(1+\alpha^{0}+\alpha^{y}\right)u_{i,j}^{n}+\zeta u_{i.j+1}^{n}+\eta u_{i,j-1}^{n}
\]
